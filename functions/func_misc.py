...
def get_coverages(host, user='', pw='', wcs_version='2.0.1', use_credentials=False, get_query=False):
    '''
    ...
    '''
    query = f'{host}?SERVICE=WCS&version={wcs_version}&request=GetCapabilities'
    if get_query == True:
        print(query)
